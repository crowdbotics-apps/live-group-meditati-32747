...
## Project Structure
    ...
    ├── live_group_meditati_32747  # Django project configurations
...
1. Clone this repo and `cd live_group_meditati_32747`
...
2. Clone this repo and `cd live_group_meditati_32747`
